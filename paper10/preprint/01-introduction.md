...
`paper10/research/02-de-donder-gauge-vertex.md`); A2 proved (Lemma A2; research memo
`paper10/research/03-a2-graviphoton-radion-sector.md`); A3 proved (Lemma A3; research
memo `paper10/research/04-a3-kk-loop-momentum-range.md`).
...
(research memo `paper10/research/01-three-graviton-vertex.md`): the triangle coupling
