...
CP² × S² × S¹ is 7-dimensional. The ~~extra dimension~~ additional phase fiber is S¹ — the
e-circle.<!-- legacy 2026-04-15 Intervention 8 §0.10: "extra dimension" → "additional phase fiber" (Vocabulary Canon entry 2: internal phase / U(1) phase fiber preferred over "extra dimension"). -->
