...
- Theorem K.1 proof: `integers/paper01-qg5d/appendices/22-appendix-k-higher-loop-epstein.md` Section K.7b
...
- S^2 spectral zeta: `integers/paper04-sm-gauge-group/appendix-D-higgs-naturalness.md`
- Higgs mass analysis: `etc/frontier-research/problem2-higgs-mass.md`
- Flux stabilisation: `integers/paper07-moduli-gut/03-moduli-minimum.md`
- GUT condition derivation: `integers/paper04-sm-gauge-group/appendix-C-gauge-coupling-hierarchy.md`
- Torsion coefficient: `integers/paper07-moduli-gut/02-gvw-superpotential.md`
