...
*Added 2026-04-14. Amplifies the geometric meaning of Theorem K.4 (all-orders inductive bootstrap) and the Mercedes Route-C BPHZ factorization in the programme's chessboard framework. Companion file at `integers/paper10-scheme-independence/preprint/06-geometric-intuition-two-faced-board.md`.*
