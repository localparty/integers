# Appendix F — The Dark Energy Equation of State (Summary)

> **Summary, 2026-04-14 (Intervention 6, MERGE-3):** The framework predicts
> `w₀ = −1`, `w_a = 0` — an exact cosmological constant equation of state.
> This follows from the perturbative exactness of the Casimir potential
> (Epstein zero theorem) combined with the `ε ~ 10⁻¹²²` suppression of the
> dilaton slow-roll parameter. DESI DR2 (arXiv:2503.14738) reports `4.2σ`
> evidence for `w ≠ −1`; DESI DR3 (2027) will decide. The full derivation
> (dilaton freezing, potential exactness, DESI comparison, falsification
> criteria) is given in Paper 6 Appendix A.

**Canonical derivation:** see
`integers/paper06-thermal-history/appendix-A-dilaton-freezing.md`.

**Cross-references:**
- Paper 1 Theorem K.1 (Universal Epstein Vanishing) — forces `V = V₀/φ⁴`
  to all perturbative orders.
- Paper 6 §2 — Epstein zero theorem applied to the e-circle Casimir energy.
- Paper 6 Appendix A — full dilaton-freezing derivation; DESI comparison;
  falsification criteria.

<!--
LEGACY CONTENT — Intervention 6 MERGE-3 (2026-04-14):
The full derivation below is preserved here as non-destructive archive.
Canonical location is now `integers/paper06-thermal-history/appendix-A-dilaton-freezing.md`.
Do not extend this legacy content; extend the canonical file instead.
