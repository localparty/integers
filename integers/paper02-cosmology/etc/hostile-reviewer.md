...
```
etc/integers/paper02-cosmology/
...
- `integers/paper01-qg5d/abstract.md`
- `integers/paper01-qg5d/appendices/appendix-W-orbifold-dark-sector.md` — Z₂ orbifold
- `integers/paper01-qg5d/appendices/appendix-Y-hubble-tension.md` — Hubble tension / N_eff
- `integers/paper01-qg5d/appendices/appendix-Q-frw-cosmology.md` — FRW cosmology context
- Paper 1 has its own hostile reviewer at `integers/paper01-qg5d/etc/hostile-reviewer.md`

### What to read

Read ALL files in `integers/paper02-cosmology/` — every section, every appendix (A through I),
and `integers/paper02-cosmology/abstract.md`. Read the prior audits and CAMB scripts listed
above. Read `integers/paper02-cosmology/etc/refs.bib`.
...
Check against `integers/paper02-cosmology/etc/refs.bib`.
...
Produce your review in `etc/integers/paper02-cosmology/02-in-depth-review.md` with sections:
