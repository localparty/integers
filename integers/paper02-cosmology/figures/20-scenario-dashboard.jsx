...
const scenarios = {
  ...
  B: { name: "Scenario B", sub: "leading-order 1/ξ²", xi: 0.432, H0: 68.7, age: 13.47, S8: 0.785,
...
const observables = [
  ...
  { key: "Neff", label: "N_eff", min: 2.6, max: 3.6,
    refs: [{ val: 3.044, label: "SM", c: C.planck }, { val: 2.86, label: "ACT DR6", c: C.tension }, { val: 3.43, label: "CMB+SH0ES", c: C.resolved }] },
