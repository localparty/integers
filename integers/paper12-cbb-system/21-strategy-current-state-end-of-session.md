...
|:---------|:-----:|:---------|
| Research notes | ~90 | integers/paper12-cbb-system/research/01-87 (with gaps) |
| Root ledger files | 21 | integers/paper12-cbb-system/00-21 |
| Program components | 17 | integers/paper12-cbb-system/preprint/00-17 |
| Python scripts | ~10 | integers/paper12-cbb-system/code/ |
| Paper 12 manuscript TOC | 1 | integers/paper12-cbb-system/manuscript/00-table-of-contents.md |
| Paper 13-16 TOCs | 4 | paper13-16/00-table-of-contents.md |
| Paper 3 addendum | 1 | integers/paper03-bh-info/addendum-tomita-takesaki-identification.md |
| Master dictionary | 1 | integers/paper12-cbb-system/18-master-dictionary.md |
| G-voice audit ledger | 1 | integers/paper12-cbb-system/19-G-voice-audit-applied.md |
...
(integers/paper12-cbb-system/19-G-voice-audit-applied.md).
