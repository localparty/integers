...
derivations. The strategy file (`integers/paper12-cbb-system/14`) Section 4.2 lists the
...
`integers/paper04-sm-gauge-group/preprint/03-the-explicit-kk-reduction-on-cp-s-s.md`. We
