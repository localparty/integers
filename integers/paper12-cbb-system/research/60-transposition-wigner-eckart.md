...
- `integers/paper12-cbb-system/research/04-identity-12-rigorous.md` — the unitary U
...
- `integers/paper12-cbb-system/research/21-bost-connes-system-reference.md` §5 — the
  Galois action on A_BC.
