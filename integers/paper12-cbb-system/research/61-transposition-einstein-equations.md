...
- `integers/paper12-cbb-system/research/02-quantize-R-construction.md` — R̂ construction.
- `integers/paper12-cbb-system/research/04-identity-12-rigorous.md` — Identity 12.
- `integers/paper12-cbb-system/research/05-derive-cc-formula.md` — CC formula, vacuum solution.
...
- `integers/paper12-cbb-system/research/41-deduction-dark-energy-beyond-CC.md` — modular time.
