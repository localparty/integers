...
*Sub-phase 3.B, thread 3g.2, of `integers/paper12-cbb-system/03-phase-3-plan.md`.*
...
From `integers/paper11a-all-orders-finiteness/04-all-orders-inductive-proof.md` (verbatim content
...
- `../../integers/paper11a-all-orders-finiteness/04-all-orders-inductive-proof.md` — **Theorem K.4,
  verbatim source**
- `../../integers/paper11a-all-orders-finiteness/research/02-inductive-bootstrap-all-orders.md` —
  earlier research note on the bootstrap structure
- `../../integers/paper01-qg5d/appendices/22-appendix-k-higher-loop-epstein.md` —
  Theorem K.1 (Universal Epstein vanishing), P1 of K.4
- `../../integers/paper10-scheme-independence/` — Lemma A1 (vertex mass-independence), P2 of K.4
