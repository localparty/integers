...
*Phase 2 of `integers/paper12-cbb-system/00-attack-plan.md`. Sequel to*
...
- `../../integers/paper11b-sm-gauge-entanglement/preprint/05-derivation-and-mechanism.md` — Paper 11's
  GHZ orbit and the A_2 root system
- `../../integers/paper11b-sm-gauge-entanglement/research/22-adiabatic-continuity-closed.md` — Phase 1
  closure precursor
