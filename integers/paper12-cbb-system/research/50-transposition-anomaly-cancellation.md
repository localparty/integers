...
- `integers/paper12-cbb-system/research/19-galois-orbit-decomposition-HR.md` — the Path B
  tensor reading and the {1, 4, 6, 8} Galois orbits.
- `integers/paper12-cbb-system/research/49-transposition-wess-zumino.md` — R-Theorem C.1
...
- `integers/paper12-cbb-system/research/21-bost-connes-system-reference.md` — BC system
  reference.
- `integers/paper12-cbb-system/research/22-cc-hierarchy-as-spectral-gap.md` — Dixmier
