...
*audit `integers/paper12-cbb-system/15-audit-and-missing-research-files.md`). Builds on:*
...
- `../../integers/paper04-sm-gauge-group/preprint/03-the-explicit-kk-reduction-on-cp-s-s.md`
  — the KK reduction on S¹ × S² × CP² giving the 1/(2π)
- `../../integers/paper01-qg5d/preprint/02-the-geometry.md` — the M⁴ × CP² × S² × S¹
  spacetime
