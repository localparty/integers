...
> `integers/paper01-qg5d/code/pin1-matrix-elements/` and
> `integers/paper01-qg5d/code/pin1-cp-enhancement/`) gives*
...
> sum (Agent N 2026-04-14,* `integers/paper01-qg5d/code/pin1-cp-enhancement/`*),
...
`integers/paper01-qg5d/code/pin1-matrix-elements/FINDINGS.md`). The "80× below"
...
> `integers/paper01-qg5d/code/pin1-cp-enhancement/FINDINGS.md` for the gauge-sector
...
`integers/paper01-qg5d/code/pin1-cp-enhancement/`.]*
