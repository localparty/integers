...
From `integers/paper12-cbb-system/preprint/12-high-precision-formulas.md` (verified to
...
- `../../integers/paper11b-sm-gauge-entanglement/research/14-oc2-exact-formula-verified.md` — the
