...
*Companion script: `integers/paper12-cbb-system/code/wigner_eckart_real_symmetric_test.py`.*
...
- `integers/paper12-cbb-system/research/19-galois-orbit-decomposition-HR.md` — the
...
- `integers/paper12-cbb-system/research/80-finite-C8-bracket-calculation.md` — the
  1 ⊕ 1 ⊕ 3 ⊕ 3̄ decomposition of H_□ and BC-intrinsic SU(3).
- `integers/paper12-cbb-system/code/wigner_eckart_real_symmetric_test.py` — companion
