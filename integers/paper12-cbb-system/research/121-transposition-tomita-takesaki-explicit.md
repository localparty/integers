...
- `integers/paper12-cbb-system/research/04-identity-12-rigorous.md` -- Identity 12, the
  unitary U : H_e -> H_1.
...
- `integers/paper12-cbb-system/research/66-transposition-CPT.md` -- R-Theorem S.1,
  J_1 = C_BC P_BC T_BC.
- `integers/paper12-cbb-system/research/73-deduction-black-hole-entropy.md` -- modular
