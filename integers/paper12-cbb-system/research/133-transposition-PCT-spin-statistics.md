...
- `integers/paper12-cbb-system/research/66-transposition-CPT.md` — the J_1 construction.
- `integers/paper12-cbb-system/research/67-transposition-spin-statistics.md` — the Z_2
  grading.
