...
*Phase 1 of `integers/paper12-cbb-system/00-attack-plan.md`.*
...
documented in `integers/paper11b-sm-gauge-entanglement/research/12-adiabatic-continuity-cp2-sigma.md`
and the script `integers/paper11b-sm-gauge-entanglement/code/cp2_sigma_mass_gap.py`. They are summarised
...
- `../../integers/paper11b-sm-gauge-entanglement/research/22-adiabatic-continuity-closed.md`
  — the original closure note (this file is the formal Paper 12
  version)
- `../../integers/paper11b-sm-gauge-entanglement/research/12-adiabatic-continuity-cp2-sigma.md`
  — the original analysis with the four methods
- `../../integers/paper11b-sm-gauge-entanglement/19-four-independent-methods-confirmed.md`
  — mid-session update
- `../../integers/paper11b-sm-gauge-entanglement/code/cp2_sigma_mass_gap.py`
...
- [ ] A root ledger file `integers/paper12-cbb-system/01-phase-1-adiabatic-closed.md`
