...
*Sub-phase 3.B, threads 3g.3 and 3g.4, of `integers/paper12-cbb-system/03-phase-3-plan.md`.*
...
- **Theorem 7.2** — `integers/paper03-bh-info/11-scrambling-time.md` (fast scrambler
...
- **Phase 1 closure** — `integers/paper12-cbb-system/research/01-adiabatic-closure.md`
...
- `integers/paper12-cbb-system/03-phase-3-plan.md` — sub-phase 3.B structure; this
...
- `integers/paper12-cbb-system/research/08-rh-as-physical-theorem.md` — sub-phase 3.C;
  provides the {γ_n} ⊂ spec(T_BC) inclusion on which Part B
  conditionally rests.
- `integers/paper12-cbb-system/preprint/03-the-transposition.md` — to be updated with
