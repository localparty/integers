...
*programme of `integers/paper12-cbb-system/14-grand-strategy-...md` §3.4 item 8:*
...
- `integers/paper12-cbb-system/research/05-derive-cc-formula.md` — the CC formula
  derivation; γ_2 as the m = 2 PT mode with |V_12|² ≈ 0.24.
- `integers/paper12-cbb-system/research/06-cosmic-transition-amplitudes.md` — the
  level-crossing mechanism (§5.2) that this note identifies with
  the Higgs mechanism.
- `integers/paper12-cbb-system/research/09-pattern-of-zero-indices.md` — γ_2 as the
...
- `integers/paper12-cbb-system/research/27-derive-mH.md` — m_H = γ_2·γ_6/(2π) at 0.40%;
...
- `integers/paper12-cbb-system/14-grand-strategy-...md` §3.4 item 8 — the planning
