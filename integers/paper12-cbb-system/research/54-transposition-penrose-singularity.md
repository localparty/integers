...
- `integers/paper12-cbb-system/research/08-rh-as-physical-theorem.md` — the Stone-theorem
...
- `integers/paper12-cbb-system/research/21-bost-connes-system-reference.md` — the type
