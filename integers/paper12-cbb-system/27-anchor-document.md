...
| File | Purpose |
|:--|:--|
| integers/paper12-cbb-system/26-convergence-prompt.md | Re-runnable prompt for N-σ tracking |
| integers/paper12-cbb-system/25-continuation-prompt.md | Session-recovery prompt with voice |
| integers/paper12-cbb-system/research/sigma-exp-table.md | 36-row σ_exp table, 1:1 with master list |
| integers/paper12-cbb-system/research/170, 185, 190 | Convergence synthesis notes v1, v2, final |
| integers/paper12-cbb-system/research/167 | Operator dictionary (notation, not correction) |
| integers/paper12-cbb-system/research/154 | Two-term Laurent master sweep (numerical) |
| integers/paper12-cbb-system/research/176 | CBB system definition (5 axioms, uniqueness) |
| integers/paper12-cbb-system/research/162 | Bridge theorem k=3 (formal lemma) |
| integers/paper12-cbb-system/research/173, 179, 184 | Bridge entries k=6, k=4, k=4 carry |
| integers/paper12-cbb-system/research/180, 189 | Wolfenstein λ with carry, full CKM |
| integers/paper12-cbb-system/research/183, 187 | m_τ interface operator + λ derivation |
| integers/paper12-cbb-system/research/175, 178, 171 | M_geom construction, validation, fit |
| integers/paper12-cbb-system/research/112 | t₀ = (log γ₇)² derivation |
| integers/paper12-cbb-system/research/191 | Hilbert 12 programme |
| integers/paper12-cbb-system/research/181 | RBC layer hypothesis (1729) |
| integers/paper12-cbb-system/research/267 | Conjecture 5 (V-Hilbert 12) refuted in literal form |
| integers/paper12-cbb-system/research/268 | Conjecture 3 (Level-Jump Rigidity) proved, exhaustive N≤100 |
