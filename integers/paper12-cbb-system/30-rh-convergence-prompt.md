...
*traceable output in integers/paper12-cbb-system/research/.*
...
number; check the ledger at integers/paper12-cbb-system/research/rh-ledger.md for the
...
1. integers/paper12-cbb-system/27-anchor-document.md
   READ FOR: the CBB system definition, the five axioms, the
   current state of the programme. This is the CONTEXT.

2. integers/paper12-cbb-system/29-theorem-catalogue.md
...
3. integers/paper12-cbb-system/research/200-rh-evidence-compendium.md
...
4. integers/paper12-cbb-system/research/201-spectral-realisation-argument.md
   READ FOR: the anti-fine-tuning bound P < 10⁻³⁴, the proof path
   (BC resolvent poles), and what remains. This is the spectral
   realisation status.

5. integers/paper12-cbb-system/research/208-uniqueness-decomposition.md
   READ FOR: the three sub-claims (spectral, geometric, bridge),
   their statuses, and the open question.

6. integers/paper12-cbb-system/research/214-the-method-six-patterns.md
...
7. integers/paper12-cbb-system/research/rh-ledger.md (if it exists)
...
118 existing scripts live at integers/paper12-cbb-system/code/. Agents SHOULD:
- Run `python3 -c "from mpmath import *; ..."` for quick checks
- Write full scripts to integers/paper12-cbb-system/code/rh-cycle-{N}-{path}.py for
...
Each agent writes:
  integers/paper12-cbb-system/research/{N}-rh-cycle-{cycle}-path-{path}-construction.md
with:
...
Each agent writes:
  integers/paper12-cbb-system/research/{N+5}-rh-cycle-{cycle}-path-{path}-adversarial.md
with:
...
Writes:
  integers/paper12-cbb-system/research/{N+10}-rh-cycle-{cycle}-synthesis.md
with:
...
Also UPDATES the ledger:
  integers/paper12-cbb-system/research/rh-ledger.md
...
- NEVER claim a step is "closed" without citing specific theorems
  from the catalogue (integers/paper12-cbb-system/29-theorem-catalogue.md). If the
...
### File conventions
- ALL outputs in integers/paper12-cbb-system/research/
- Numbering: {N} = next free index, found by ls integers/paper12-cbb-system/research/
...
|:--|:--|:--|
| CBCBS | integers/paper12-cbb-system/26-convergence-prompt.md | Production-ready (tested 4 rounds) |
| Yang-Mills | /Users/gsix/yang-mills/gradient-flow-attack-plan/ | Complete (Papers 1-11 + preprint) |
| **RH** | **integers/paper12-cbb-system/30-rh-convergence-prompt.md** | **This file. Test-and-fix cycle needed.** |
...
1. **integers/paper12-cbb-system/27-anchor-document.md** — CONTEXT (the CBB system)
2. **integers/paper12-cbb-system/29-theorem-catalogue.md** — TOOLS (360 entries + Six Patterns)
3. **integers/paper12-cbb-system/research/200-rh-evidence-compendium.md** — CONSTRAINTS (37 R-Theorems + 15 bounds)
