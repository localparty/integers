...
(verified at 5 ppb in `integers/paper12-cbb-system/preprint/12-high-precision-formulas.md`)
...
- `../integers/paper11b-sm-gauge-entanglement/` — the gauge group from three-qubit entanglement
  (closed)
...
Root files (`integers/paper12-cbb-system/NN-*.md`) record the running state of the
...
| 22 | 22-corrections-addenda-master-list.md | **All corrections master list**: 20 honest findings, 20 corrections applied, 2 Paper 3 addenda, 41 G-voice edits, 37 R-Theorem names |
| 23 | 23-what-we-learned-reflection.md | **The discovery story in G's voice**: CC as γ_1, hierarchy dissolving, predictive grammar, Wolfenstein = PT order, LOCK's 37 teeth, crossing = KMS, the three unifications |
...
Research notes (`integers/paper12-cbb-system/research/NN-*.md`):
