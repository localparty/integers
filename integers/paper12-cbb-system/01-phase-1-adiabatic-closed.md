...
| `../integers/paper11b-sm-gauge-entanglement/research/22-adiabatic-continuity-closed.md` | The original session closure note (this file is the formal Paper 12 version) |
| `../integers/paper11b-sm-gauge-entanglement/code/cp2_sigma_mass_gap.py` | The 4-method numerical script |
