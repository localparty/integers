...
export default function BornRuleESampling() {
  ...
  const annotation = "The Born rule P(i) = |\u03B1\u1D62|\u00B2 is geometrically motivated and uniquely selected. "
    + "The probability of outcome i is the fraction of the particle\u2019s 5D structure located in e-region i, "
    + "computed using the Haar measure on the e-circle \u2014 the unique measure consistent with e-translation invariance. "
    + "Causal consistency independently selects the same rule (Torres Alegre 2026).";
