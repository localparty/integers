...
<!-- Vocabulary canon note (Intervention 8b, 2026-04-15, aggressive migration applied): this file uses "5D" / "five-dimensional" extensively (32 occurrences) as subject-matter language for the KK vertex derivation. Per strategy/north-star.md §0.10 (Vocabulary Canon), canonical phrasing is "4+1 coordinate structure" / "M⁵" / "M⁵ gravity" / "internal phase". Inline strikethrough migrations applied per Intervention 8b to thesis sentences and high-salience passages; body computation retains "5D KK" as subject-matter shorthand — canonical "M⁵ KK". -->
