# Appendix Q — FRW Cosmology in the 4+1 Framework (M⁵)<!-- legacy 2026-04-15 Intervention 8b §0.10: "in the 5D Framework" → "in the 4+1 Framework (M⁵)" -->
...
> This appendix derives the modified Friedmann equations from the ~~5D~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D" → "M⁵" --> Einstein
