# Appendix D — The M⁵ Einstein Equations and the Gravity Program<!-- legacy 2026-04-15 Intervention 8b §0.10: "The 5D Einstein Equations" → "The M⁵ Einstein Equations" -->

<!-- Vocabulary canon note (Intervention 8b, 2026-04-15, aggressive migration applied): this file uses "5D" / "five-dimensional" / "fifth dimension" / "5D Einstein" extensively as subject-matter language. Per strategy/north-star.md §0.10 (Vocabulary Canon), canonical phrasing is "4+1 coordinate structure" / "M⁵" / "internal phase" / "S¹ coordinate". Inline strikethrough migrations applied per Intervention 8b to thesis sentences, H1 heading, and high-salience passages. The appendix's filename retains "5d-einstein-equations" for stable cross-references (Intervention-8b file-rename exclusion). -->
