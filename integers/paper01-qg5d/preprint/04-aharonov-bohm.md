...
<!-- Original: "Both follow from the single geometric postulate that the e-dimension is a circle." -->
Both effects are topological. Both are quantized. Both follow from the single
geometric ~~postulate~~ **Theorem T2** (S¹-uniqueness, Paper 61 §13.5, per
strategy/paper1-audit/derivation-chains.md §T2) that the e-dimension is a
circle. The Aharonov-Bohm effect and the Pauli exclusion principle are
cousins — different manifestations of the same underlying e-space topology.
