...
<!-- Vocabulary canon note (Intervention 8b, 2026-04-15, aggressive migration applied): this file uses "five-dimensional" / "5D" / "fifth dimension" as subject-matter language. Per strategy/north-star.md §0.10 (Vocabulary Canon), canonical phrasing is "4+1 coordinate structure" / "M⁵" / "internal phase" / "S¹ coordinate". Inline strikethrough migrations applied to thesis sentences, headings, and high-salience passages per Intervention 8b. -->

---

## Preamble

The ~~five-dimensional framework~~ 4+1 framework (M⁵)<!-- legacy 2026-04-15 Intervention 8b §0.10: "five-dimensional framework" → "4+1 framework (M⁵)" --> established in Section 2 makes a specific claim:
every quantum phenomenon is a geometric consequence of ~~five-dimensional structure~~ 4+1 coordinate structure<!-- legacy 2026-04-15 Intervention 8b §0.10: "five-dimensional structure" → "4+1 coordinate structure" -->
...
<!-- Original: "It follows from Postulate 3 of Section 2.7 — e-translation invariance — by Noether's theorem" -->
This is the e-analog of momentum conservation: `p₁ + p₂ = constant`. It follows
from ~~Postulate 3~~ **Theorem T3** of Section 2.7 — e-translation invariance —
by Noether's theorem (Noether 1918 + U(1) isometry of S¹, per
strategy/paper1-audit/derivation-chains.md §T3), exactly as momentum
conservation follows from spatial translation invariance.
...
separate probability postulate in the 5D framework (it is derived as
Theorem D2 per strategy/paper1-audit/derivation-chains.md §D2: Haar-measure
uniqueness on U(1) forced by T3 + Gleason 1957), but its derivation has two
...
<!-- legacy 2024 framing, reclassified 2026-04-15 per strategy/paper1-audit/ -->
<!-- Original: "forced by e-translation invariance (Postulate 3)" and "not from a probability postulate" -->
...
`dφ/2π` — forced by e-translation invariance (~~Postulate 3~~ **Theorem T3**;
strategy/paper1-audit/derivation-chains.md §T3). The 5D density
...
the measure comes from the symmetry, not from an independent probability
postulate (see also Theorem D2, derivation-chains.md §D2).
