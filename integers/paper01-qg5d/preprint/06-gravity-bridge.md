...
<!-- Vocabulary canon note (Intervention 8b, 2026-04-15, aggressive migration applied): this file uses "five-dimensional" / "5D" / "fifth dimension" / "5D gravity" / "5D Einstein" as subject-matter language. Per strategy/north-star.md §0.10 (Vocabulary Canon), canonical phrasing is "4+1 coordinate structure" / "M⁵" / "M⁵ gravity" / "internal phase". Inline strikethrough migrations applied per Intervention 8b to thesis sentences and high-salience passages. -->
...
beyond ~~Postulates 1 and 2~~ **Theorems T1 and T2** of the framework (per
strategy/paper1-audit/derivation-chains.md §T1-§T2: T1 = M⁵ = M⁴ × S¹
ZFC construction; T2 = S¹-uniqueness, Paper 61 §13.5) and the equivalence
principle.
<!-- legacy 2024 framing, reclassified 2026-04-15 per strategy/paper1-audit/ -->
<!-- Original: "no new assumptions required beyond Postulates 1 and 2 of the framework and the equivalence principle." -->
