...
Before writing anything, check whether `integers/paper01-qg5d/journal-reviewer/` contains any
files (report.md, gap-responses.md, or others).

If it does:
1. List the directories in `integers/paper01-qg5d/reviewer-runs/` (they are named r00, r01, r02, ...).
   If none exist, the next run number is r00.
2. Find the next available number (e.g. if r00 and r01 exist, use r02).
3. Create `integers/paper01-qg5d/reviewer-runs/rNN/` (e.g. `mkdir -p integers/paper01-qg5d/reviewer-runs/r02/`).
4. Move all files from `integers/paper01-qg5d/journal-reviewer/` into `integers/paper01-qg5d/reviewer-runs/rNN/`.
5. Proceed with the review. Write all new output fresh to `integers/paper01-qg5d/journal-reviewer/`.

If `integers/paper01-qg5d/journal-reviewer/` is empty or does not exist, skip directly to the review.
...
**Core paper:**
1. `integers/paper01-qg5d/00-abstract.md`
2. `integers/paper01-qg5d/01-introduction.md`
3. `integers/paper01-qg5d/02-framework.md`
4. `integers/paper01-qg5d/05-spin-statistics.md`
5. `integers/paper01-qg5d/03-five-phenomena.md`
6. `integers/paper01-qg5d/04-aharonov-bohm.md`
7. `integers/paper01-qg5d/07-quantization-bridge.md`

**Appendices (required — these carry the key technical claims):**
8. `integers/paper01-qg5d/appendices/13-appendix-b-spin-statistics-derivation.md`
9. `integers/paper01-qg5d/appendices/17-appendix-f-one-loop-computation.md`
10. `integers/paper01-qg5d/appendices/18-appendix-g-two-loop-computation.md`
11. `integers/paper01-qg5d/appendices/22-appendix-k-higher-loop-epstein.md`
12. `integers/paper01-qg5d/appendices/30-appendix-s-finiteness-theorem.md`
13. `integers/paper01-qg5d/appendices/32-appendix-u-goroff-sagnotti-verification.md`
14. `integers/paper01-qg5d/appendices/23-appendix-l-non-abelian-extension.md`
15. `integers/paper01-qg5d/appendices/12-appendix-a-quantum-dictionary.md`
16. `integers/paper01-qg5d/appendices/14-appendix-c-quantitative-demonstrations.md`

**Prior review (read to avoid re-litigating settled issues):**
17. `integers/paper01-qg5d/etc/hostile-reviewer.md`
...
Write your complete review to `integers/paper01-qg5d/journal-reviewer/report.md`.
