...
```
/Users/gsix/quantum-geometry-in-5d/integers/paper01-qg5d/
├── abstract.md
...
```
/Users/gsix/quantum-geometry-in-5d/integers/paper01-qg5d/etc/arxiv/main.tex
```

Plus a bibliography file:

```
/Users/gsix/quantum-geometry-in-5d/integers/paper01-qg5d/etc/arxiv/refs.bib
```
...
```
/Users/gsix/quantum-geometry-in-5d/integers/paper01-qg5d/etc/arxiv/
...
tables and equations. The JSX files in `integers/paper01-qg5d/figures/` are conceptual
...
```
main.tex            — the complete paper
refs.bib            — bibliography (from integers/paper01-qg5d/etc/refs.bib)
```
