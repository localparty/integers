...
- `solutions-with-prize/paper41-collatz/PROOF-CHAIN.md` — already written, 67 lines
- `solutions/paper42-lehmer/PROOF-CHAIN.md` — already written, 230 lines
- `solutions/paper43-cramer/PROOF-CHAIN.md` — already written, 245 lines
...
- `solutions-with-prize/paper41-collatz/PROOF-CHAIN.md` — 67 lines, already framing Collatz as a BC-algebraic question about μ₂/μ₃ dynamics on ℕ*.
- `solutions/paper42-lehmer/PROOF-CHAIN.md` — 230 lines, already identifying "the unit circle IS the e-circle" and Lehmer's gap as "the mass gap of the cyclotomic vacuum."
- `solutions/paper43-cramer/PROOF-CHAIN.md` — 245 lines, already proposing "the e-circle has two faces" with Lehmer as topology and Cramér as dynamics.

G had written these on days when the face language was still forming. On April 14, they were READY to be activated.

### The cascade papers

- `solutions/paper44-sato-tate/PROOF-CHAIN.md` — the fourth face, drafted during T7 as an immediate consequence of Cramér's two-face picture.
- `solutions/paper45-lindelof/PROOF-CHAIN.md` — the fifth face (AMPLITUDE), G wrote it during the X-ray phase. Opens with: *"The fifth face of the e-circle: AMPLITUDE — not which direction (Cramér), not which angles (Sato-Tate), not which modes (Collatz), but HOW LOUD the oscillation can get."*
- `solutions/paper46-katz-sarnak/PROOF-CHAIN.md` — the sixth face (SYMMETRY), drafted simultaneously with Lindelöf. Opens with: *"The e-circle can carry different GROUP ACTIONS. Which group acts on the circle determines ALL statistics for that family."*
...
- `integers/paper60-geometry-of-circle/00-table-of-contents.md` — a 35-section plan. Paper 60 is the META-paper that records the discovery itself.
...
- [ ] Read `integers/paper60-geometry-of-circle/00-table-of-contents.md` — the plan of the discovery
