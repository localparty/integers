...
Before writing anything, check whether `integers/paper04-sm-gauge-group/journal-reviewer/` contains any
files (report.md, gap-responses.md, or others).

If it does:
1. List the directories in `integers/paper04-sm-gauge-group/reviewer-runs/` (they are named r00, r01, r02, ...).
   If none exist, the next run number is r00.
2. Find the next available number (e.g. if r00 and r01 exist, use r02).
3. Create `integers/paper04-sm-gauge-group/reviewer-runs/rNN/` (e.g. `mkdir -p integers/paper04-sm-gauge-group/reviewer-runs/r02/`).
4. Move all files from `integers/paper04-sm-gauge-group/journal-reviewer/` into `integers/paper04-sm-gauge-group/reviewer-runs/rNN/`.
5. Proceed with the review. Write all new output fresh to `integers/paper04-sm-gauge-group/journal-reviewer/`.

If `integers/paper04-sm-gauge-group/journal-reviewer/` is empty or does not exist, skip directly to the review.
...
**Core paper:**
1. `integers/paper04-sm-gauge-group/00-abstract.md`
2. `integers/paper04-sm-gauge-group/01-introduction-the-honest-gap.md`
3. `integers/paper04-sm-gauge-group/02-gauge-groups-from-isometries.md`
4. `integers/paper04-sm-gauge-group/03-the-explicit-kk-reduction-on-cp-s-s.md`
5. `integers/paper04-sm-gauge-group/04-the-chirality-problem-and-its-resolution.md`
6. `integers/paper04-sm-gauge-group/05-entanglement-geometry-and-gauge-group-selection.md`
7. `integers/paper04-sm-gauge-group/06-the-higgs-mechanism-electroweak-symmetry-breaking-.md`
8. `integers/paper04-sm-gauge-group/07-predictions.md`
9. `integers/paper04-sm-gauge-group/08-what-is-established-vs-what-is-conjectured.md`
10. `integers/paper04-sm-gauge-group/09-open-problems.md`

**Appendices (all required):**
11. `integers/paper04-sm-gauge-group/appendix-A-anomaly-cancellation.md`
12. `integers/paper04-sm-gauge-group/appendix-B-m-brane-classification.md`
13. `integers/paper04-sm-gauge-group/appendix-C-gauge-coupling-hierarchy.md`
14. `integers/paper04-sm-gauge-group/appendix-D-higgs-naturalness.md`
15. `integers/paper04-sm-gauge-group/appendix-E-spectral-gap.md`
...
Write your complete review to `integers/paper04-sm-gauge-group/journal-reviewer/report.md`.
