...
*What the programme IS, in G's words. The ~~five-dimensional geometry~~ 4+1 coordinate geometry <!-- legacy 2026-04-15: "five-dimensional geometry" migrated to "4+1 coordinate geometry" per §0.10 canon entry 1, Intervention 8 -->. The Riemann zeros as eigenvalues of the universe's operator algebra. Zero free parameters. The spectral-geometric duality as the single insight from which everything follows. "The physics IS the mathematics." Why this programme exists and what it means to the originator. (~2 pages)*

**Source**: `integers/paper12-cbb-system/27-anchor-document.md`, `integers/paper01-qg5d/preprint/00-abstract.md`, conversation transcripts (2026-04-13).

### 02 — The 4+1 coordinate geometry (QG5D) <!-- legacy 2026-04-15: section title "The five-dimensional geometry" migrated to "The 4+1 coordinate geometry" per §0.10 canon entry 1, Intervention 8 -->
*The foundational framework: spacetime has a 4+1 coordinate structure — (x,y,z,t,e) — where the internal-phase coordinate e is circular and corresponds to the U(1) fiber <!-- legacy 2026-04-15: "spacetime is five-dimensional" / "fifth dimension e" migrated to "spacetime has a 4+1 coordinate structure" / "internal-phase coordinate e" per §0.10 canon entries 1+2, Intervention 8 -->. Every quantum phenomenon is a geometric consequence of projection from 4+1 to 4 spacetime coordinates. Paper 1's core results: spin-statistics from winding number, Aharonov-Bohm from bundle holonomy, Born rule from 4+1 density, perturbative finiteness of KK gravity. The 22 derivations. (~5 pages)*

**Source**: `integers/paper01-qg5d/preprint/*.md` (10 sections), `integers/paper01-qg5d/appendices/` (26 appendices).
...
**Source**: `integers/paper12-cbb-system/27-anchor-document.md`, `integers/paper12-cbb-system/18-master-dictionary.md`, `integers/paper12-cbb-system/research/167-log-R-master-reformulation.md`.
...
**Source**: `integers/paper12-cbb-system/research/23-framework-predictions-master-table.md`, `integers/paper11b-sm-gauge-entanglement/29-the-standard-model-riemann-correspondence.md`.
...
**Source**: `integers/paper12-cbb-system/research/213-theorem-catalogue-grammar.md`, `integers/paper12-cbb-system/research/158-bridge-theorem-z3.md`, `integers/paper12-cbb-system/research/162-cocycle-equality-k3.md`, `integers/paper12-cbb-system/research/179-pati-salam-bridge.md`.
...
**Source**: `integers/paper02-cosmology/preprint/*.md`, `integers/paper02-cosmology/camb/`, `integers/paper02-cosmology/appendices/`.
...
**Source**: `solutions-with-prize/paper13-rh/preprint/00-proof-skeleton.md`, `solutions-with-prize/paper13-rh/preprint/PROOF-CHAIN.md`, `solutions-with-prize/paper13-rh/strategy/28-all-gaps-closed.md`, `solutions-with-prize/paper13-rh/strategy/10-state-after-18-kills.md`.
...
**Source**: `solutions-with-prize/paper08-yang-mills/preprint/PROOF-CHAIN.md`, `solutions-with-prize/paper08-yang-mills/chain-verification/chain/chain-state.md`, `solutions-with-prize/paper08-yang-mills/h4-capacitor-bypass/BLACKBOARD.md`.
...
**Source**: `solutions-with-prize/paper26-bsd/preprint/PROOF-CHAIN.md`, `solutions-with-prize/paper26-bsd/strategy/05-route3-kms-projector-bypass.md`.
...
**Source**: `solutions-with-prize/paper28-pvnp/strategy/07-toolkit-complete.md`, `solutions-with-prize/paper28-pvnp/strategy/04-ora--seven-routes-one-wall.md`, `solutions-with-prize/paper28-pvnp/strategy/10-amplification-entries.md`.
...
**Source**: `solutions-with-prize/paper08-yang-mills/closing-H4/closure/closure-digest.md`, `solutions-with-prize/paper13-rh/preprint/00-proof-skeleton.md`, `solutions-with-prize/paper28-pvnp/strategy/04-ora--seven-routes-one-wall.md`.
...
**Source**: Connes-Consani-Marcolli arXiv:math/0512138, Gaitsgory-Raskin arXiv:2405.03599, `integers/paper12-cbb-system/relaxation/04-*-strategy.md`.

### 13 — Navier-Stokes existence and smoothness
*The connection via gradient flow: YM Links 15-17 (gradient flow on gauge connections) IS a parabolic PDE in the same class as Navier-Stokes (parabolic PDE on velocity fields). The spectral gap Δ > 0 controls long-time regularity. The fluid/gravity correspondence (~~5D Einstein~~ M⁵ Einstein<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D Einstein" → "M⁵ Einstein" --> → 4D effective fluid). The candidate proof chain at 5/10. What remains. (~4 pages)*

**Source**: `solutions-with-prize/paper08-yang-mills/preprint/sections/L-clay-conjectures.md` (gradient flow), `integers/paper03-bh-info/` or `integers/paper04-sm-gauge-group/` (NS candidate chain), fluid/gravity literature.
...
**Source**: `integers/paper12-cbb-system/research/191-next-math-branch.md`, `paper25/` (if exists), publishing strategy Wave 2.
...
**Source**: `solutions-with-prize/paper13-rh/preprint/00-proof-skeleton.md`, bridge family files, GRH literature.
...
**Source**: Baum-Connes literature, `integers/paper12-cbb-system/` K-theory references, nLab Baum-Connes entry.

### 17 — Berry-Tabor / BGS spectral statistics
*The Montgomery-Odlyzko law: Riemann zeros obey GUE (Gaussian Unitary Ensemble) statistics. The framework's spectral realization makes this a theorem about modular flow on the BC algebra: the flow is ergodic (type III₁ factor), which produces GUE statistics. Connection to quantum chaos: the ~~5D geometry~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D geometry" → "M⁵" --> is "quantum chaotic" in the spectral sense. (~3 pages)*

**Source**: `integers/paper12-cbb-system/research/121-tomita-takesaki.md`, Montgomery 1973, Odlyzko 1987, random matrix theory literature.
...
**Source**: `integers/paper12-cbb-system/research/09-pattern-of-zero-indices.md`, explicit formula literature.
...
**Source**: `integers/paper12-cbb-system/27-anchor-document.md` (operator dictionary), Schanuel's conjecture literature.
...
**Source**: `integers/paper12-cbb-system/research/214-the-method-six-patterns.md`, `integers/paper12-cbb-system/research/14-transposition-CCM-and-reasoning-patterns.md`.
...
**Source**: `millenium-apps/proof-chain-adversarial-01/09-capacitor-correspondence-table-v1.md`, `solutions-with-prize/paper08-yang-mills/h4-capacitor-bypass/capacitor/updates/wave1-cell-fills.md`, `verification-cascade/strategy/01-capacitor-architecture.md`.
...
**Source**: `integers/paper12-cbb-system/relaxation/01-strategy-rationale.md`, `integers/paper12-cbb-system/relaxation/04-*-strategy.md`, brainstorm sessions 2026-04-13.
...
**Source**: framework philosophy, conversation transcripts, `integers/paper12-cbb-system/27-anchor-document.md` SP1-SP5.
...
- Part I (§01-06): 2 agents in parallel (one for §01-03, one for §04-06). Primary source: integers/paper01-qg5d/, integers/paper02-cosmology/, integers/paper12-cbb-system/.
