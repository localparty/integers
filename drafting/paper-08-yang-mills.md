...
**Toolkit:** Use `paper08-yang-mills/research/36-the-method.md`
(the Six Patterns) as the voice/method reference. Use
`paper08-yang-mills/preprint/PROOF-CHAIN.md` as the structural
backbone.
...
(overwriting the old versions). The old versions are preserved in
git history.
...
*Four ORA runs. Same pattern as Paper 28. The paper is proved.
The writing needs to match.*
