# arXiv Endorsement Request — Minimal Disclosure Email

## Strategy

Send abstract + key results only. Do NOT attach the full PDF until
endorsement is confirmed. This minimizes disclosure while giving
enough technical content to demonstrate the work is serious and
within hep-th scope.
...
Subject: arXiv endorsement request (hep-th) — 5D Kaluza-Klein framework
...
- Replace [CODE] with the actual endorsement code from arXiv
- Do NOT attach PDFs to this first email
- If he agrees to endorse, send the PDFs in a follow-up
- If he asks for the full paper before committing, that is reasonable
  and normal — send it at that point (he has expressed interest, which
  is a good sign)
