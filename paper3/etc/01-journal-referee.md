...
Before writing anything, check whether `paper3/journal-reviewer/` contains any
files (report.md, gap-responses.md, or others).

If it does:
1. List the directories in `paper3/reviewer-runs/` (they are named r00, r01, r02, ...).
   If none exist, the next run number is r00.
2. Find the next available number (e.g. if r00 and r01 exist, use r02).
3. Create `paper3/reviewer-runs/rNN/` (e.g. `mkdir -p paper3/reviewer-runs/r02/`).
4. Move all files from `paper3/journal-reviewer/` into `paper3/reviewer-runs/rNN/`.
5. Proceed with the review. Write all new output fresh to `paper3/journal-reviewer/`.

If `paper3/journal-reviewer/` is empty or does not exist, skip directly to the review.
...
**Core paper:**
1. `paper3/00-abstract.md`
2. `paper3/01-the-paradox-and-where-hawking-s-calculation-lives.md`
3. `paper3/02-the-5d-e-dimension-framework-relevant-results-from.md`
4. `paper3/03-the-problem-of-time-and-its-resolution.md`
5. `paper3/04-the-horizon-as-s-s-information-lives-on-the-surfac.md`
6. `paper3/05-as-the-information-bit-acausal-propagation.md`
7. `paper3/06-hawking-radiation-structured-in-e.md`
8. `paper3/07-the-page-curve-quantitative-recovery.md`
9. `paper3/08-bekenstein-hawking-entropy-why-s-a-4-in-5d.md`
10. `paper3/09-the-firewall-paradox-resolution-via-e-dimension-ge.md`
11. `paper3/10-connection-to-the-island-formula.md`
12. `paper3/11-scrambling-time.md`
13. `paper3/12-hawking-s-theorem-and-its-5d-loophole.md`

**Appendices (required):**
14. `paper3/15-appendix-a-non-perturbative-completion.md`
15. `paper3/16-appendix-b-horizon-vertex.md`
...
Write your complete review to `paper3/journal-reviewer/report.md`.
