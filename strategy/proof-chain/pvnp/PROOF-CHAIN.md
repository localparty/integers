...
| 5 | Non-full <-> Taylor equivalence | FORWARD (Taylor -> non-full): numerically supported by `solutions-with-prize/paper28-pvnp/code/pvnp_nonfullness_test.py` + Bulatov-Zhuk external -- treat as numerically settled. BACKWARD (non-full -> Taylor): OPEN -- the genuine wall. | 1-4 |
