...
- **BC -> QG5D:** The spectral action Tr(f(D/Lambda)) is defined
  using K-theoretic data. The ~~5D geometry~~ 4+1 coordinate structure <!-- legacy 2026-04-15: "5D geometry" → "4+1 coordinate structure" per north-star.md §0.10 Vocabulary Canon, Intervention 8 (Agent B) --> is encoded in the
