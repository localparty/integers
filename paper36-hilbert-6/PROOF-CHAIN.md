...
- `paper1/preprint/*.md` — 4 postulates + 22 theorems
- `paper12/27-anchor-document.md` — CBB 5-axiom definition
- `paper12/research/23-framework-predictions-master-table.md` — 36 pins
