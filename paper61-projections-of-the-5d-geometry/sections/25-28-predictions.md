...
The master reference for all 36 pins is `paper12/research/23-framework-predictions-master-table.md`. Every numerical claim below traces to that table.
