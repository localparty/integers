...
## §13 — The 5D Geometry as the Unprojected Object

### 13.1 The product manifold $M^5 = M^4 \times S^1$

The unprojected object from which every shadow in this paper originates is the five-dimensional product manifold
...
We call $e$ the **fifth coordinate**, the **e-coordinate**, or the **phase coordinate**. A point of $M^5$ is a pair $(x^\mu, e)$.
...
### 13.3 The five-dimensional metric and Kaluza-Klein decomposition
...
The image is the **36-dimensional measurement vector** of Branch E — a point in $\mathbb{R}^{36}$ whose coordinates are the 36 physical predictions (27 spectral, 9 geometric, 1 interface) tabulated in `paper12/research/23-framework-predictions-master-table.md`.
...
The composition framework has a computational implementation in `paper12/research/14-transposition-CCM-and-reasoning-patterns.md`. When a proof chain link $L_k$ in paper $i$ is stuck in domain $D_a$, the transposition protocol:
