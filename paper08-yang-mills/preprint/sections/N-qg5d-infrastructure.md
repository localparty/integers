...
string-theoretic dualities from the QG5D programme enter the Yang--Mills
...
Paper 1 establishes the foundational spectral results for linearised 5D
...
> effective action for linearised 5D gravity on $M^4 \times S^1$, with
...
> Lichnerowicz operator for linearised 5D gravity in de Donder gauge on
...
> gauge, the 5D three-graviton vertex numerator, after KK decomposition
...
> for the Goroff--Sagnotti counterterm in 5D linearised gravity on
...
> in all schemes.*
>
> *This result is unconditional within linearised 5D gravity on flat
...
> **Theorem 4.3** (Paper 10, Section 4.5). *In 5D linearised gravity on
...
Yang--Mills theory on $\mathbb{R}^4$ invoke results from 5D
...
of 5D gravity, but their mathematical content is independent of that
context.
