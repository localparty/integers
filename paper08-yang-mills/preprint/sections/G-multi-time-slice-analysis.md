This appendix documents a stress-test of the temporal derivative mechanism in the continuum limit argument. An error in an earlier version of the closing argument was identified here and corrected; the spectral intermediate-state mechanism (Section 5.5) is the result. The appendix is included to show the argument has been critically examined.
