...
**Balaban's Main Estimate (CMP 109, Theorem 1; detailed: Theorem 3):** For each polymer
...
radius (Dimock, arXiv:1108.1335, Thm 14). Dimock, arXiv:1212.5562 (2013), treats
...
**Source:** Balaban, CMP 109, Theorem 1 (detailed: Theorem 3); CMP 119, Theorem (unnumbered, p. 245).
...
1. Polymer expansion convergence: Balaban, CMP 109 (1987), Thm 1 (detailed: Thm 3);
   CMP 119 (1988), Theorem (unnumbered, p. 245).
2. Propagator analyticity: Balaban, CMP 95 (1984), Sec. 3--4;
   CMP 96 (1984), Sec. 2--3.
3. Kernel analyticity: Balaban, CMP 98 (1985), Sec. E
   (analyticity properties of the averaging operations).
4. Uniformity in $k$: CMP 109, Sec. 3 (inductive hypotheses);
   $\kappa$ does not depend on $k$.
5. Modern exposition: Dimock, arXiv:1108.1335 (2011), Thm 14.
