...
`/Users/gsix/quantum-geometry-in-5d-latex/paper08-yang-mills/` unless
otherwise noted. Rigor labels follow `research/21-the-rigorous-proof.md`
(which the BSD test case `paper26-bsd/strategy/04-closing-my4.md` also
uses):
...
inherits the discrete spectrum from the 5D KK-enhanced lattice via
...
6. **Write up as `paper08-yang-mills/research/W11-XX-route-A-h4.md`**
   (~10-15 pages).

### Route B (CCM 2025 port) — punch list

1. **Read `paper13-rh/preprint/sections-06-10.md` §6 (CCM operators)**
...
6. **Write up as `paper08-yang-mills/research/W11-XX-route-B-ccm-port.md`**
...
6. **Write up as `paper08-yang-mills/research/W11-XX-route-C-spectral-action.md`**
   (~15-20 pages).
...
- `paper12/27-anchor-document.md` (legacy operational anchor)
- `paper12/relaxation/04-geometric-spectral-cross-formula-cross-forms-cross-integers-cocycle-ccm-predictions-etc-strategy.md` (the seven-anchor strategy doc — for the relaxation context, which includes H4 closure)

**For the H4 closure specifically**:
- `paper08-yang-mills/preprint/sections/L-clay-conjectures.md` (Conjecture L.2 statement)
- `paper08-yang-mills/notation-math-referee/runs/r00/gap-closing-work/tier-3-clay/G4b-af-short-distance-match.md` (G4b formal gap statement)
- `paper08-yang-mills/notation-math-referee/runs/r00/gap-closing-work/tier-3-clay/G4d-operator-product-expansion.md` (G4d formal gap statement)
- `paper08-yang-mills/gradient-flow-attack-plan/research/W7-14-af-match.md` (the prior W7 attack on G4b — the W7-14 reframing of H4)
- `paper08-yang-mills/gradient-flow-attack-plan/research/W7-15-ope-leading.md` (the prior W7 attack on G4d)

**For Route B (CCM 2025 port)** specifically:
- `paper13-rh/preprint/sections-06-10.md` (the CCM/ITPFI/Bögli/Hurwitz template)
- `paper13-rh/preprint/00-proof-skeleton.md` (the proof skeleton)
...
- `paper12/research/162` (the bridge cocycle k=3 closure, which establishes the methodology)
- `paper12/research/179` (the k=4 Pati-Salam bridge analog)

### YM proof chain context (always included for any YM-related run)

- `paper08-yang-mills/preprint/PROOF-CHAIN.md` (the 18-step chain)
- `paper08-yang-mills/research/21-the-rigorous-proof.md` (rigor labels)
- `paper08-yang-mills/research/35-final-verdict.md` (the canonical
  closure-digest in §J register, for voice-alignment reference)

### BSD MY4 closure as the canonical example

`paper26-bsd/strategy/05-route3-kms-projector-bypass.md` is the
...
all defended by the seven-anchor strategy of `paper12/relaxation/04-...-strategy.md`.
