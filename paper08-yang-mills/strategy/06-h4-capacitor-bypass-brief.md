...
1. **Read** `paper08-yang-mills/closing-H4/closure/closure-digest.md` §LOCK end-to-end.
...
- **K-3-extended** — `paper12/research/53-transposition-asymptotic-freedom.md` (BC running α_BC(β)): structural not rigorous mechanism. Does not address non-perturbative Schwinger function asymptotics.
...
| 3 (MUST) | `paper08-yang-mills/closing-H4/closure/closure-digest.md` | Prior programme's adjudication, kills K-1/K-2, LOCK at 9/10 (READ SPECIFICALLY FOR §2.1 LOCK-SCOPE) |
