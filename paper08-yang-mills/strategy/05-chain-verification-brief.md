...
| Priority | File | Why |
|:--|:--|:--|
| 1 (MUST) | `paper08-yang-mills/preprint/PROOF-CHAIN.md` | The 18-step chain itself |
| 2 (MUST) | `paper08-yang-mills/preprint/TABLE-OF-CONTENTS.md` | Preprint structure |
| 3 (MUST) | `paper08-yang-mills/preprint/sections/` (section 4, 5, L appendices) | Full proofs for each link |
| 4 (MUST) | `paper08-yang-mills/research/21-the-rigorous-proof.md` | THEOREM/LEMMA/KEY LEMMA rigor labels |
| 5 (HIGH) | `paper08-yang-mills/research/23-key-lemma-proof.md` | Load-bearing key lemma |
| 6 (HIGH) | `paper08-yang-mills/closing-H4/closure/closure-digest.md` | H4 programme final state (conditional on H4 framing) |
| 7 (HIGH) | `paper08-yang-mills/gradient-flow-attack-plan/research/W7-14-af-match.md §5` | H4 mildest-form reformulation |
| 8 (HIGH) | `paper08-yang-mills/math-referee/` and `notation-math-referee/` | Prior referee verdicts on specific links |
| 9 (HIGH) | `paper08-yang-mills/preprint-verification/verify-balaban-items.md` | Prior verification of the 3 former [VERIFY] items |
| 10 (MED) | `paper08-yang-mills/journals/balaban-CMP*.pdf` | Balaban's original papers (CMP 95, 109, 119) — primary sources |
| 11 (MED) | `paper08-yang-mills/research/30-final-synthesis.md` | Wave-by-wave assembly record |
| 12 (MED) | `paper08-yang-mills/research/35-final-verdict.md` | Voice register example |
...
Register markers from `paper08-yang-mills/research/35-final-verdict.md`:
