...
functions are literal shapes in ~~5D space~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D space" → "M⁵" -->. Applied to the mass gap:
...
are shapes in ~~5D~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: bare "5D" → "M⁵" -->. It ended with the Yang-Mills mass gap: confinement
is curvature in 11D.
