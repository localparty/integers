...
| $\theta_{\text{QCD}} = 0$ | 0 | $\pi_4(SU(3)) = 0$ in ~~5D~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: bare "5D" → "M⁵" --> | 4 |
...
| Hawking radiation is thermal | ~~5D state~~ M⁵ state<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D state" → "M⁵ state" --> is pure; 4D is a partial trace | 3 |
