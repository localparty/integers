...
**Check 8 (Weyl anomaly):** a_total = (43/360)*S_0 = 0 and c_total = (87/20)*S_0 = 0 exactly, since S_0 = 0. The ~~5D~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: bare "5D" → "M⁵" --> anomaly cancellation follows from the KK mode count vanishing.
