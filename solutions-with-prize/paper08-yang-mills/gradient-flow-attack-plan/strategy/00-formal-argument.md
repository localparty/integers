...
> Lichnerowicz operator for ~~linearized 5D gravity~~ linearized M⁵ gravity<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D gravity" → "M⁵ gravity" --> in de Donder gauge on
...
> for ~~linearized 5D gravity~~ linearized M⁵ gravity<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D gravity" → "M⁵ gravity" --> on $M^4 \times S^1$, with KK mode sums
...
> Goroff--Sagnotti counterterm in ~~5D linearized gravity~~ M⁵ linearized gravity<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D linearized gravity" → "M⁵ linearized gravity" --> on
...
|:-------|:------|:---------|:-------------------------------|
| Postulates P1--P4 | 1 | Section 2.7, lines 334--350 | Foundation: ~~5D spacetime~~ M⁵ spacetime<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D spacetime" → "M⁵ spacetime" --> $M^4 \times S^1$ |
| ~~5D metric decomposition~~ M⁵ metric decomposition<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D metric" → "M⁵ metric" --> | 1 | Appendix D, Section D.2 | KK mode structure |
| ~~5D Ricci scalar~~ M⁵ Ricci scalar<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D Ricci scalar" → "M⁵ Ricci scalar" --> $\hat{R} = R^{(4)} - \tfrac{1}{4}\kappa^2\phi^2 F_{\mu\nu}F^{\mu\nu} - 2(\Box\phi)/\phi$ | 1 | Appendix D, Section D.3 | Field content of KK theory |
