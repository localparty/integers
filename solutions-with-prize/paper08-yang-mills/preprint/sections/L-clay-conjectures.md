...
**Step 3 (KK tower decoupling).** The ~~five-dimensional origin~~ 4+1 coordinate-structure origin of the
construction introduces a KK tower of massive modes.<!-- legacy 2026-04-15: "five-dimensional origin" migrated per north-star §0.10 entries 1-2, Intervention 8 --> These do not
