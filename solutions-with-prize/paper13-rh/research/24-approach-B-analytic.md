...
- `/solutions-with-prize/paper13-rh/code/r56_approach_B_analytic.py`: Lambda scan, N=10
- `/solutions-with-prize/paper13-rh/code/r56_approach_B_analytic.json`: Raw output
