...
enumerated by `solutions-with-prize/paper26-bsd/referee/code/ccm_over_K_sanity.py`,
...
- `meyer-extension-to-K.md` — provides (M3') and (L3), the
  ...
  `τ^{(K_∞)}`.
- `solutions-with-prize/paper13-rh/preprint/sections-01-05.md` §3.3 (the ℚ template
  for `Q_N`), §3.4 (parity), §3.2 (even sector).
- `solutions-with-prize/paper13-rh/preprint/sections-06-10.md` §6.1 eq. (6.1)–(6.2)
  (the decomposition `QW_λ = T_0 + τ^(R)` with
  `T_0 = τ^(0,2) + Σ_p τ^(p)`).
- `solutions-with-prize/paper26-bsd/referee/code/ccm_over_K_sanity.py` — Gaussian
