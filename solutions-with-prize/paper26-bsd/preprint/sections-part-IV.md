...
| L-value | L(E, 1) | Ω/4 |
| Real period | Ω_E | Ω = Γ(1/4)² / (2·√(2π)) ≈ 2.62205755... |
...
roots). The period that enters is:
    ...
    Ω_E = Γ(1/4)² / (2·√(2π)) ≈ 2.62205755...

(equivalently Ω_E = Γ(1/4)² / √(8π); this is the classical lemniscatic
period, cf. Zagier's expression or LMFDB curve 32.a3. Note: the
expression Γ(1/4)²/(2π)^{3/2} that appeared in an earlier draft is
off by a factor of π; numerical value 2.62205755 is correct.)
