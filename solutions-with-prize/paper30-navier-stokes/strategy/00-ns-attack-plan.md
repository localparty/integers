...
- **Energy estimates:** The ~~5D~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: bare "5D" → "M⁵" --> energy-momentum conservation (Killing
...
## Route B: Fluid/gravity correspondence (from ~~5D Einstein~~ M⁵ Einstein)<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D Einstein" → "M⁵ Einstein" -->
...
gradient expansion. The programme's ~~5D geometry~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D geometry" → "M⁵" --> (M^4 x S^1, not AdS_5)
...
The question: does the gradient expansion converge? If so, the ~~5D Einstein equations~~ M⁵ Einstein equations<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D Einstein equations" → "M⁵ Einstein equations" -->
rigorously contain the NS equations as a subsector.
...
- **Link 6 (energy descent):** The ~~5D geometry~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D geometry" → "M⁵" --> has a Killing vector
...
2. **Search for additional structure.** What property of the KK
   ...
   identity in ~~5D~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: bare "5D" → "M⁵" -->, the dilaton equation of motion.
...
2. **Error bounds.** Can the BHMR expansion be bounded at finite order?
   Even a rigorous first-order result (~~5D Einstein~~ M⁵ Einstein<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D Einstein" → "M⁵ Einstein" --> -> NS + bounded
...
- **Paper 1 -> Paper 30:** The ~~5D geometry~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D geometry" → "M⁵" --> (M^4 x S^1, metric ansatz,
