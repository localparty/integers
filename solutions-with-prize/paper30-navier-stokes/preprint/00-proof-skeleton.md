...
transfer from Paper 8. Proof strategy: Begin with the ~~5D Einstein equations~~ M⁵ Einstein equations<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D Einstein equations" → "M⁵ Einstein equations" -->
on M^4 x S^1 and perform classical Kaluza-Klein dimensional
...
is the wall). KK energy conservation in ~~5D~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: bare "5D" → "M⁵" --> descends to NS energy
...
|:-----|:----------|:-------|:-------|
| 1. KK reduction | ~~5D Einstein~~ M⁵ Einstein<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D Einstein" → "M⁵ Einstein" --> on M^4 x S^1 -> KK reduction yields 4D Einstein + Maxwell + scalar (dilaton). Classical, fully rigorous. | **LITERATURE** | Kaluza 1921, Klein 1926, Paper 1 |
| 2. Fluid/gravity dictionary | Stress-energy T_mu_nu in near-equilibrium Landau frame -> incompressible NS at leading order in gradient expansion. Rigorous direction (~~5D geometry~~ M⁵<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D geometry" → "M⁵" --> -> 4D PDE) unproved. | **CONJECTURED** | Bhattacharyya-Hubeny-Minwalla-Rangamani 2008 |
...
| 6. Energy descent | KK energy conservation (~~5D Killing~~ M⁵ Killing<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D Killing" → "M⁵ Killing" --> symmetry) -> NS energy dissipation (4D viscous term) -> Leray-Hopf regularity upgrade. Energy structure transfers but dissipation mechanism needs proof. | **CONJECTURED** | Leray 1934, Hopf 1951 |
...
```
Link 1:  M⁵ Einstein on M^4 x S^1  (KK reduction, classical)<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D Einstein" → "M⁵ Einstein" -->
           |
...
Link 5:  BKM criterion  (spectral gap -> vorticity control -> no blowup)
           |               [THE WALL]
Link 6:  Energy descent  (M⁵ conservation -> 4D dissipation -> Leray-Hopf)<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D conservation" → "M⁵ conservation" -->
           |
...
- **Kaluza 1921, Klein 1926:** Classical KK dimensional reduction.
  M⁵ vacuum Einstein -> 4D Einstein + Maxwell + scalar. Fully rigorous.<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D vacuum Einstein" → "M⁵ vacuum Einstein" -->
...
- **Paper 1** (QG5D foundation): KK reduction in the programme context.
  M⁵ metric ansatz, dilaton dynamics, compactification radius R.<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D metric" → "M⁵ metric" -->
...
- **Spectral gap Delta_0^KK > 0:** The compactification radius R of the
  ~~extra dimension S^1~~ internal phase fiber S^1 (the e-circle) sets a spectral floor lambda_1 = (2 pi / R)^2.
  Modes above this floor are exponentially damped by the KK tower.
  <!-- legacy 2026-04-15: "extra dimension" migrated per north-star §0.10 entry 2, Intervention 8 (S^1 is a U(1) phase fiber, not a spatial axis) -->
...
- **Compactification radius R bounds max vorticity:** Smaller R (stronger
  ...
  compactness of the ~~fifth dimension~~ internal phase (the e-circle S^1).
  <!-- legacy 2026-04-15: "fifth dimension" migrated per north-star §0.10 entries 1-2, Intervention 8 -->
...
fluid/gravity dictionary (Link 2) to embed NS in M⁵, then<!-- legacy 2026-04-15 Intervention 8b §0.10: "5D geometry" → "M⁵" -->
