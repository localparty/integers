...
- `paper30-navier-stokes/preprint/00-proof-skeleton.md` — original 8-link skeleton
- `paper30-navier-stokes/strategy/00-ns-attack-plan.md` — attack plan with Route A/B/C breakdown
