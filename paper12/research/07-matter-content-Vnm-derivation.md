...
(b) **Order-of-magnitude estimates** of c_p for typical SM matter
    ...
    `paper4/03-the-explicit-kk-reduction-on-cp-s-s.md` (Section 4).
...
From the KK reduction of `paper4/03-the-explicit-kk-reduction-
...
- `../../paper4/03-the-explicit-kk-reduction-on-cp-s-s.md` — the
  KK reduction of the SM on CP² × S² × S¹ used in Section 4.
- `../../paper4/appendix-C-gauge-coupling-hierarchy.md` — the
  one-loop β-function coefficients used in (4.8)–(4.9).
- `../../paper11/research/23-cc-formula-extreme-precision.md` —
