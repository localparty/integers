...
- `paper12/research/19-galois-orbit-decomposition-HR.md` -- Galois
...
- `paper12/research/67-transposition-spin-statistics.md` -- R-Theorem
  S.2 and the Z_2 grading.
- `paper12/research/68-transposition-goldstone.md` -- R-Theorem S.3,
...
- `paper12/research/121-transposition-tomita-takesaki-explicit.md` --
