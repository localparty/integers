...
*Gap 1 of `paper12/15-audit-and-missing-research-files.md`.*

---

## 0. Why This File Exists

Almost every research note in `paper12/research/` cites "the Connes–
...
`paper12/15-audit-and-missing-research-files.md`. It is complete when:
