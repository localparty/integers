...
From `paper12/preprint/13-the-pattern-of-zeros.md` (frequency table)
and `paper12/preprint/11-the-standard-model-riemann-correspondence.md`
(the 23 fits):
...
- `../../paper11/preprint/00-program.md` — Paper 11, the gauge
