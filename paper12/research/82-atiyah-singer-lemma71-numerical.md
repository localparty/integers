...
*Companion script: `paper12/code/atiyah_singer_lemma71_computation.py`*
...
The companion script `paper12/code/atiyah_singer_lemma71_computation.py`
...
- `paper12/research/76-Atiyah-Singer-integer-route-to-math-RH.md` --
...
- `paper12/code/atiyah_singer_lemma71_computation.py` --
