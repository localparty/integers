...
*Prompt heritage:* specialisation of `paper12/26-convergence-prompt.md` to
the CAMB cosmological sector only.
*Driver:* `/Users/gsix/quantum-geometry-in-5d/paper2/camb/compute_age.py`
*Venv:* `/Users/gsix/quantum-geometry-in-5d/paper2/camb/.venv/` (camb 1.6.6)
*Results artifact:* `/Users/gsix/quantum-geometry-in-5d/paper2/camb/results.json`
...
All framework inputs are from `paper12/research/23-framework-predictions-master-table.md`
