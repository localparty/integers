...
*Closes the one remaining open box of `paper12/research/33-BC-intrinsic-SU3-*
...
*Companion script: `paper12/code/hecke_three_primes_brackets.py`.*
...
- [x] The companion script
      `paper12/code/hecke_three_primes_brackets.py` is written and runs
