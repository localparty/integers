...
that were tested and refuted in `paper12/relaxation/research/T7c-stark-rescue-verification.md`.
...
(`paper12/relaxation/research/T1-T2-brauer-cohomology-verification.md`)
...
- **Seven-anchor strategy (primary)**:
  `paper12/relaxation/04-geometric-spectral-cross-formula-cross-forms-cross-integers-cocycle-ccm-predictions-etc-strategy.md §4 Anchor 5` —
  "Cyclotomic Brauer class, half-standing" restatement.
- **Strategy rationale (T7 retirement)**:
  `paper12/relaxation/01-strategy-rationale.md` — T7 entry marked
...
- **T7c script**: `paper12/relaxation/research/code/T7c-stark-rescue.py`.
- **Prior refutations**:
  `paper12/research/188-character-decomposed-rbc.md` (L'(1,χ)/L(1,χ)),
  `paper12/research/267-stark-units-computation.md` (raw Stark phase + exhaustive character scan).
