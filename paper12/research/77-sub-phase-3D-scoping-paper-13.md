...
*Parent: `paper12/14-grand-strategy-transposition-quantization-deduction.md`*
...
- `paper12/research/21-bost-connes-system-reference.md` — Finding 1,
...
- `paper12/research/48-transposition-atiyah-singer-index.md` —
  ...
  Chain C.
- `paper12/research/54-transposition-penrose-singularity.md` — the
