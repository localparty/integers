...
- `paper12/research/04-identity-12-rigorous.md` — H_R definition.
- `paper12/research/10-transposition-gauge-group-3primes.md` — A_2
  triality (Z_3) used in §2.1; the three primes underlying H_3gen.
- `paper12/research/16-fix-14-missing-parameters.md` — the 11 fitted
  CKM/PMNS formulas used in §3.
- `paper12/research/19-galois-orbit-decomposition-HR.md` — Path B
  three-generation subspace; the conditional foundation.
- `paper12/research/25-derive-fine-structure.md` — γ_4 channel
  used in §9.4.
