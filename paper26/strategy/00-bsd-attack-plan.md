...
*Modelled on the RH convergence architecture (paper12/30-rh-convergence-prompt.md)*
...
Same as RH (paper12/30-rh-convergence-prompt.md):

**Layer 1 — Construction** (1 agent per active path):
- Read the theorem catalogue (paper12/29-theorem-catalogue.md)
