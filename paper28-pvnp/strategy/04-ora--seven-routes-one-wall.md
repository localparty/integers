...
**Idea:** The SM-Riemann correspondence (paper11/29) shows each
...
| File | Est. tokens | Why |
|:-----|:-----------|:----|
| `paper12/research/214-the-method-six-patterns.md` | 5K | The method loop |
| `paper12/27-anchor-document.md` | 7K | Operational anchor |
| `paper28-pvnp/preprint/sections-03-boolean-bc-system.md` | 5K | M_Bool construction |
| `paper28-pvnp/preprint/sections-04-rtheorem-pnp1.md` | 5K | The theorem statement |
| `paper28-pvnp/strategy/03-non-fullness-iff-taylor.md` | 6K | Strategy 03 (wall analysis) |
| `paper19/sections-03.md` | 8K | Conditional expectation as collapse (Route C) |
| `paper11/29-the-standard-model-riemann-correspondence.md` | 8K | Channel pattern (Route C template) |
| `paper13-rh/preprint/00-proof-skeleton.md` | 4K | Transposition template |
