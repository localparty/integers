# Point-by-Point Claim Tester: Per-Claim Verification of Paper 28 (P vs NP)

You are an expert mathematical referee performing a *fine-grained, claim-by-claim* verification of Paper 28 *"P versus NP as the Computational Shadow of the Spin–Statistics Theorem"*. Your job is the dual of the proof-chain referee in `00-original-advanced-math-referee.md`: where the proof-chain referee asks "is the overall logic sound?", you ask "for *each individual numbered claim* in the paper, can it be verified, and does it actually say what the surrounding text claims it says?"
...
Read the following references locally before reading the preprint:
- `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/referee/references/cook-clay-pvsnp.pdf` — Cook's official Clay statement (the binding text).
- `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/referee/references/aaronson-pnp-survey-2017.pdf` — Aaronson's 2017 survey (the canonical map of barriers and failure modes).
...
- **Self-referentially closed** — Paper 28 cites Paper 15, which cites Paper 17, which cites Paper 23, which cites Paper 28; the chain has no externally verifiable foundation.
...
**Paper 28 main text:**
- `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/preprint/00-table-of-contents.md`
- `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/preprint/sections-01-introduction.md`
- `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/preprint/sections-02-trinity-dictionary.md`
- `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/preprint/sections-03-boolean-bc-system.md`
- `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/preprint/sections-04-rtheorem-pnp1.md`
- `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/preprint/sections-05-order-counting-cross-check.md`
- `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/preprint/sections-06-three-barriers.md`
- `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/preprint/sections-07-connections-outlook.md`
- `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/preprint/appendices.md`

**Cited prior papers (you will need to grep / read these to verify imports):**
- `/Users/gsix/quantum-geometry-in-5d-latex/paper15/` — for R-Theorem S.11, the additive ↔ multiplicative dictionary §2.1, and the LOCK rigor table
- `/Users/gsix/quantum-geometry-in-5d-latex/paper17/` — for the order-counting principle §5.4.5 and the entropy operator
- `/Users/gsix/quantum-geometry-in-5d-latex/paper23/` — for the CBB quintuple §4.1, the bridge family, and the no-go theorem
- `/Users/gsix/quantum-geometry-in-5d-latex/paper26-bsd/` — for the BSD transposition mechanics §3

**External references in `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/referee/references/`** — see top of this file.
...
Write one `.md` file per claim into `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/referee/runs/<run-id>/claims/`. Use this template:
...
In `/Users/gsix/quantum-geometry-in-5d-latex/paper28-pvnp/referee/runs/<run-id>/`:
