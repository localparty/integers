...
`/Users/gsix/quantum-geometry-in-5d-latex/paper26-bsd/` unless
otherwise noted. Rigor labels follow
`paper08-yang-mills/research/21-the-rigorous-proof.md` and are
...
- `/Users/gsix/quantum-geometry-in-5d-latex/paper13-rh/preprint/sections-01-05.md`
  — §3 (Layer 1: CCM), §4 (Layer 2: ITPFI), §5 (Layer 3a:
  archimedean)
- `/Users/gsix/quantum-geometry-in-5d-latex/paper13-rh/preprint/sections-06-10.md`
  — §6 (Layer 3b), §7 (Layer 3c), §8 (Layer 3d), §9 (Layer 4:
  Teschl–Bögli), §10 (Layer 5: Hurwitz)
- `/Users/gsix/quantum-geometry-in-5d-latex/paper13-rh/preprint/sections-11-14.md`
