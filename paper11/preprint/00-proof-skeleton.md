...
**Proof source.** `/Users/gsix/quantum-geometry-in-5d-latex/paper11/09-paper-11-proof-chain.md` §Theorem 11.1 (Steps 1-4, pp. 24-95 in file); companion file `/Users/gsix/quantum-geometry-in-5d-latex/paper11/research/07-paper-11-a2-root-system-from-slocc.md` (numerical verification + explicit Killing form).
...
**Proof source.** `/Users/gsix/quantum-geometry-in-5d-latex/paper11/09-paper-11-proof-chain.md` §Theorem 11.2 (Steps 1-5 + corollary); companion files `/Users/gsix/quantum-geometry-in-5d-latex/paper11/research/08-paper-11-econs-ghz-bridge.md` (bridge argument; documents the failed 3-tangle route and why the stabiliser route is the correct one); `/Users/gsix/quantum-geometry-in-5d-latex/paper11/11-paper-11-caveats-closed.md` §Caveat 2 (uniqueness: W-orbit stabiliser is U(1)_diag with constraint a₁=a₂=a₃, which does NOT match e-conservation's Σa=0).
...
**Proof source.** `/Users/gsix/quantum-geometry-in-5d-latex/paper11/09-paper-11-proof-chain.md` §Theorem 11.3 (Steps 1-6); companion file `/Users/gsix/quantum-geometry-in-5d-latex/paper11/research/09-paper-11-kirillov-orbit.md` (moment-map construction; product vs non-product stabiliser distinction).
...
**Proof source.** `/Users/gsix/quantum-geometry-in-5d-latex/paper11/09-paper-11-proof-chain.md` §Theorem 11.4 (Steps 1-4, including weight verification against standard Dynkin labels); companion file `/Users/gsix/quantum-geometry-in-5d-latex/paper11/research/20-fermion-decomposition-detail.md` (detailed table of T² weights for all 8 basis states + SU(3) irrep matching + "colour = entanglement pattern" interpretation).
...
**Four residual caveats — all explicitly closed in `paper11/11-paper-11-caveats-closed.md`:**
...
- **Paper 24 / programme thread** (Riemann physics bridge, arithmetic-to-physics transposition): Paper 11's identification "physics is a corollary of arithmetic" (via the e-circle-as-theorem results in `paper11/25-the-e-circle-is-a-theorem-of-number-theory.md` and the Riemann-zero formulas in `paper11/research/13-28`) extends the main theorem to cosmological constant, fine structure, N_eff, mass ratios.

**Lateral (sibling chains):**

- **Paper 11 Section 9** (holonomy table completion): connects to `paper11/research/11-cp2-area-law-confinement.md` and `paper11/research/12-adiabatic-continuity-cp2-sigma.md`.
...
**Top-level strategy / assembly / narrative (paper11/):**

- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/08-paper-11-outline.md` — structural outline of the 8 sections
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/09-paper-11-proof-chain.md` — **primary source for Thms 11.1-11.5 statements and proofs** (~400 lines)
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/10-paper-11-caveats.md` — original caveat list
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/11-paper-11-caveats-closed.md` — **closure of all four caveats**
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/15-master-assembly-map.md` — assembly map naming Thms 11.1-11.5 and their files
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/16-paper-11-abstract.md` — draft abstract
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/17-paper-11-introduction.md` — draft introduction (Sections 1.1-1.6)
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/18-unification-narrative.md` — high-level narrative for Section 9
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/26-the-big-picture-status-and-audit.md` — status audit (all five theorems listed as CLOSED)

**Research notes (paper11/research/):**

- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/research/07-paper-11-a2-root-system-from-slocc.md` — **Theorem 11.1 detail** (Killing form, Cartan matrix, A₂ identification, Z_6 derivation)
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/research/08-paper-11-econs-ghz-bridge.md` — **Theorem 11.2 detail** (stabiliser bridge, failed 3-tangle route)
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/research/09-paper-11-kirillov-orbit.md` — **Theorem 11.3 detail** (Kirillov / moment-map / Borel-de Siebenthal)
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/research/10-paper-11-formal-proof-chain.md` — formal proof-chain summary (5 theorems tabulated)
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/research/20-fermion-decomposition-detail.md` — **Theorem 11.4 detail** (all 8 weights, SU(3) irrep matching, colour-as-pattern)
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/research/11-cp2-area-law-confinement.md` — CP² area law (for Section 9 holonomy table)
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/research/12-adiabatic-continuity-cp2-sigma.md` and `22-adiabatic-continuity-closed.md` — adiabatic continuity (confinement consistency)

**Computation scripts (paper11/code/):**

- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/code/slocc_a2_roots.py` — verifies Thm 11.1 (Cartan matrix ((2,-1),(-1,2)))
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/code/econs_ghz_bridge.py` — verifies Thm 11.2 (T² stabiliser match)
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/code/kirillov_orbit.py` — verifies Thm 11.3 (orbit dim = 6, moment-map structure)
- `/Users/gsix/quantum-geometry-in-5d-latex/paper11/code/fermion_quantum_numbers.py` — verifies Thm 11.4 (weights match 3 and 3̄)

**Earlier version (paper4/):**

- `/Users/gsix/quantum-geometry-in-5d-latex/paper4/` — the original "Standard Model Gauge Group from Kaluza-Klein Geometry" preprint. Paper 11 supersedes Paper 4 §5 (entanglement-geometry / gauge-group-selection) by upgrading Conjecture 5.1 + Theorem 5.2 into the rigorous Thm 11.1-11.5 chain.

---

*v1: 2026-04-14. Paper 11 preprint skeleton extracted from the paper11/ corpus (strategy files 00-31 + research/00-28). Author: G. Six. Five theorems consolidated from scattered research notes into a single proof-chain preprint backbone. All five theorems are marked PROVED in `paper11/09-paper-11-proof-chain.md` and `paper11/research/10-paper-11-formal-proof-chain.md`; all four residual caveats are closed in `paper11/11-paper-11-caveats-closed.md`. Chain is conditional only on Paper 1 (e-circle + Noether) and Paper 4 (KK correspondence + χ(CP²)=3). Next step: expand into full preprint sections following the outline in `paper11/08-paper-11-outline.md`.*
